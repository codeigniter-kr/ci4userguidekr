...
그런 다음 메서드 이름으로 뷰 이름을 지정하십시오. 이렇게하면 나중에 뷰를 찾기 쉽습니다.
...
모델의 역활은 응용 프로그램에 대한 단일 유형의 데이터를 유지 관리하는 것입니다.
