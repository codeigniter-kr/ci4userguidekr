...
동일한 캐시 스토리지를 사용하는 둘 이상의 애플리케이션이 있는 경우 여기에 모든 키 이름 앞에 추가되는 사용자 정의 접두부(prefix)를 추가할 수 있습니다.
...
디스크 I/O가 캐슁을 통해 얻는 긍정적인 이점을 없앨 수 있으므로 이를 주의하여 사용하고, 애플리케이션을 벤치마킹해야 합니다.
