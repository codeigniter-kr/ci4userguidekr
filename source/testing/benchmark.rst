...
타이머를 사용하면 애플리케이션 실행시 두 순간 사이의 시간을 측정할 수 있습니다.
따라서 애플리케이션의 다양한 성능을 간단하게 측정할 수 있습니다.
...
애플리케이션이 실행될 때 설정한 모든 타이머는 Timer 클래스에 의해 수집됩니다.
그러나 자동으로 표시하지는 않습니다.
...
실행할 작업을 추가한 후에는 ``run()`` 메서드를 사용하여 작업을 여러번 반복할 수 있습니다.
